...
public partial class PericoView : UserControl
{
    ...
    private void Button_BuildGTAHax_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (RadioButton_H4CNF_P1.IsChecked == true)
        {
            ...
            if (GetSelectedItemContent(ListBoxItem_H4_PROGRESS) == "未选择")
            {

            }
            else if (GetSelectedItemContent(ListBoxItem_H4_PROGRESS) == "普通模式")
            {
                TextBox_AppendText_MP("_H4_PROGRESS", "126823");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4_PROGRESS) == "困难模式")
            {
            ...
            if (GetSelectedItemContent(ListBoxItem_H4CNF_TARGET) == "未选择")
            {

            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TARGET) == "西西米托龙舌兰")
            {
                TextBox_AppendText_MP("_H4CNF_TARGET", "0");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TARGET) == "红宝石项链")
            {
                TextBox_AppendText_MP("_H4CNF_TARGET", "1");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TARGET) == "不记名债券")
            {
                TextBox_AppendText_MP("_H4CNF_TARGET", "2");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TARGET) == "粉钻")
            {
                TextBox_AppendText_MP("_H4CNF_TARGET", "3");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TARGET) == "玛德拉索文件")
            {
                TextBox_AppendText_MP("_H4CNF_TARGET", "4");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TARGET) == "猎豹雕像")
            {
            ...
            if (GetSelectedItemContent(ListBoxItem_H4LOOT) == "未选择")
            {

            }

            /**************************** 现金 ****************************/
            if (GetSelectedItemContent(ListBoxItem_H4LOOT) == "已发现/侦察 现金（室内/室外）")
            {
            ...
            /**************************** 大麻 ****************************/
            if (GetSelectedItemContent(ListBoxItem_H4LOOT) == "已发现/侦察 大麻（室内/室外）")
            {
            ...
            /**************************** 可可 ****************************/
            if (GetSelectedItemContent(ListBoxItem_H4LOOT) == "已发现/侦察 可可（室内/室外）")
            {
            ...
            /**************************** 黄金 ****************************/
            if (GetSelectedItemContent(ListBoxItem_H4LOOT) == "已发现/侦察 黄金（室内/室外）")
            {
            ...
            /**************************** 画作 ****************************/
            if (GetSelectedItemContent(ListBoxItem_H4LOOT_PAINT) == "已发现/侦察 画作（室内/室外）")
            {
            ...
            if (GetSelectedItemContent(ListBoxItem_H4_MISSIONS) == "未选择")
            {

            }
            else if (GetSelectedItemContent(ListBoxItem_H4_MISSIONS) == "潜水艇：虎鲸")
            {
                TextBox_AppendText_MP("_H4_MISSIONS", "65283");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4_MISSIONS) == "飞机：阿尔科诺斯特")
            {
                TextBox_AppendText_MP("_H4_MISSIONS", "65413");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4_MISSIONS) == "飞机：梅杜莎")
            {
                TextBox_AppendText_MP("_H4_MISSIONS", "65289");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4_MISSIONS) == "直升机：隐形歼灭者")
            {
                TextBox_AppendText_MP("_H4_MISSIONS", "65425");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4_MISSIONS) == "船只：巡逻艇")
            {
                TextBox_AppendText_MP("_H4_MISSIONS", "65313");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4_MISSIONS) == "船只：长鳍")
            {
                TextBox_AppendText_MP("_H4_MISSIONS", "65345");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4_MISSIONS) == "全部载具可用")
            {
            ...
            if (GetSelectedItemContent(ListBoxItem_H4CNF_WEAPONS) == "未选择")
            {

            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_WEAPONS) == "侵略者（连发散弹，连发手枪，手雷，砍刀）")
            {
                TextBox_AppendText_MP("_H4CNF_WEAPONS", "1");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_WEAPONS) == "阴谋者（军用步枪，单发手枪，粘弹，指虎）")
            {
                TextBox_AppendText_MP("_H4CNF_WEAPONS", "2");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_WEAPONS) == "神枪手（轻狙，连发手枪，燃烧瓶，小刀）")
            {
                TextBox_AppendText_MP("_H4CNF_WEAPONS", "3");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_WEAPONS) == "破坏者（MK2冲锋枪，单发手枪，土质炸弹，小刀）")
            {
                TextBox_AppendText_MP("_H4CNF_WEAPONS", "4");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_WEAPONS) == "神射手（MK2突击步枪，单发手枪，土质炸弹，砍刀）")
            {
            ...
            if (GetSelectedItemContent(ListBoxItem_H4CNF_TROJAN) == "未选择")
            {

            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TROJAN) == "机场")
            {
                TextBox_AppendText_MP("_H4CNF_TROJAN", "1");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TROJAN) == "北船坞")
            {
                TextBox_AppendText_MP("_H4CNF_TROJAN", "2");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TROJAN) == "主码头-东")
            {
                TextBox_AppendText_MP("_H4CNF_TROJAN", "3");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TROJAN) == "主码头-西")
            {
                TextBox_AppendText_MP("_H4CNF_TROJAN", "4");
            }
            else if (GetSelectedItemContent(ListBoxItem_H4CNF_TROJAN) == "混合粉")
            {
